...
class ModelTest(TestCase):
    ...
    def setUp(self):
        ...
        myvm_quotas = MyVMQuotas.objects.create(myvm_faculty=faculty_admin,
                                                ...
                                                myvm_quota_used_last_update="2018-05-28 12:00:00")
    ...
    def test_string_representation(self):
        ...
        myvm_quotas = MyVMQuotas.objects.get(myvm_faculty="si", myvm_quotas_year=2018)
